...
exports.prototype = {
    ...
    _all_events: {
      ...
      receive_segment: 4, return_segments: 5
    },
      ...
      async.each(_results,
        ...
        function (_r, _next_fn) {
          ...
          if (_r.result != 'success') {
            ...
            var attempts = (message.attempts.tx || 1);

            if (!limit || attempts < limit) {
              message.attempts.tx = attempts + 1;
    ...
    send: function (_to, _message, _transmit_callback) {
      ...
      this._outbound_queue.push({
        to: _to, content: _message, callback: _transmit_callback
      });
